...
impl const HasCase for PronounDeclInfo {
    fn case(&self) -> Case {
        self.case_number.case()
    }
}
impl const HasNumber for PronounDeclInfo {
    fn number(&self) -> Number {
        self.case_number.number()
    }
}
impl const HasAnimacy for PronounDeclInfo {
...
impl PronounDeclension {
    pub fn inflect(self, buf: &mut InflectionBuffer, info: PronounDeclInfo) {
